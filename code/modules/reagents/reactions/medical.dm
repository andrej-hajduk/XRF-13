...
/datum/chemical_reaction/aphro
	...
	results = list(/datum/reagent/drug/aphrodisiac = 5)
	required_reagents = list(/datum/reagent/carbon = 2, /datum/reagent/hydrogen = 2, /datum/reagent/water = 1)
...
/datum/chemical_reaction/anaphro
	...
	results = list(/datum/reagent/drug/anaphrodisiac = 5)
	required_reagents = list(/datum/reagent/carbon = 2, /datum/reagent/hydrogen = 2, /datum/reagent/sulfur = 1)
