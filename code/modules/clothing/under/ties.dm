...
/obj/item/clothing/tie/petcollar/Initialize()
	. = ..()
	if(treat_path)
		new treat_path(src)
/*
/obj/item/clothing/tie/petcollar/ComponentInitialize()
	. = ..()
	if(!poly_states)
		return
...
/obj/item/clothing/tie/petcollar/locked/attackby(obj/item/K, mob/user, params)
...
/obj/item/clothing/tie/petcollar/locked/attack_hand(mob/user)
	if(loc == user /*&& user.wear_tie && lock != FALSE*/)
		to_chat(user, "<span class='warning'>The collar is locked! You'll need unlock the collar before you can take it off!</span>")
		return
	..()

/obj/item/clothing/tie/petcollar/locked/leather
	name = "leather pet collar"
	icon_state = "leathercollar"
	poly_states = 2
	poly_colors = list("#222222", "#888888")
