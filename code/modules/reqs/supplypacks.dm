...
/datum/supply_packs/ammo/mateba_packet
	name = "Mateba Bullet Packet. Contains enough rounds to refill a Mateba Belt, minus the speedloaders."
	contains = list(/obj/item/ammo_magazine/mateba)
	cost = 12
	available_against_xeno_only = TRUE

/datum/supply_packs/ammo/mateba_packet/polymer
	name = "Mateba PGR Packet. Contains enough rounds to refill a Mateba Belt, minus the speedloaders."
