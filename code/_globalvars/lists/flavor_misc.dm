...
GLOBAL_LIST_INIT(underwear_m, list("None", "Briefs")) //Curse whoever made male/female underwear diffrent colours
GLOBAL_LIST_INIT(underwear_f, list("None", "Briefs", "Panties"))
	//Undershirts
