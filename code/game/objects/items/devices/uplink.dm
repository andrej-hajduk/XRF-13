...
/obj/item/uplink_tablet/captain
	...
	prices = list(
		...
		"Medical" = list(
			...
			/obj/item/reagent_containers/hypospray/autoinjector/bicaridine = 150,
			/obj/item/reagent_containers/hypospray/autoinjector/kelotane = 150,
			/obj/item/reagent_containers/hypospray/autoinjector/tramadol = 150,
			/obj/item/reagent_containers/hypospray/autoinjector/oxycodone = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/tricordrazine = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/combat = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/inaprovaline = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/dylovene = 150,
			/obj/item/reagent_containers/hypospray/autoinjector/hypervene = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/dexalinplus = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/isotonic = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/quickclot = 200,
			/obj/item/reagent_containers/hypospray/autoinjector/synaptizine = 300,
