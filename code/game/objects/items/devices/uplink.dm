...
/obj/item/uplink_tablet/captain
	...
	products = list(
		...
		"Kitchen" = list(
			...
			/obj/item/portablecrate/soda_dispenser = -1,
			/obj/item/portablecrate/beer_dispenser = -1,
			/obj/item/portablecrate/condimaster = -1,
		...
		"Equipment" = list(
			...
			/obj/item/weapon/baton/cattleprod = -1,
			/obj/item/hailer = -1,
		...
		"Crates" = list(
			...
			/obj/item/portablecrate/chem_dispenser = -1,
			/obj/item/portablecrate/chem_master = -1,
			/obj/item/portablecrate/reagentgrinder = -1,
		...
		"Prototypes" = list(
			...
			/obj/item/weapon/energy/sword = 1,
	...
	prices = list(
		...
		"Medical" = list(
			...
			/obj/item/clothing/glasses/hud/health = 200,
			/obj/item/clothing/glasses/hud/medgoggles = 1000,
			/obj/item/storage/pill_bottle/bicaridine = 200,
			/obj/item/storage/pill_bottle/kelotane = 200,
			/obj/item/storage/pill_bottle/tramadol = 250,
			/obj/item/storage/pill_bottle/tricordrazine = 100,
			/obj/item/storage/pill_bottle/inaprovaline = 100,
			/obj/item/storage/pill_bottle/dexalin = 200,
			/obj/item/storage/pill_bottle/dylovene = 200,
			/obj/item/storage/pill_bottle/spaceacillin = 250,
			/obj/item/storage/pill_bottle/alkysine = 300,
			/obj/item/storage/pill_bottle/imidazoline = 300,
			/obj/item/storage/pill_bottle/peridaxon = 300,
			/obj/item/storage/pill_bottle/quickclot = 300,
			/obj/item/storage/pill_bottle/hypervene = 300,
			/obj/item/reagent_containers/hypospray/autoinjector/bicaridine = 75,
			/obj/item/reagent_containers/hypospray/autoinjector/kelotane = 75,
			/obj/item/reagent_containers/hypospray/autoinjector/tramadol = 75,
			/obj/item/reagent_containers/hypospray/autoinjector/oxycodone = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/tricordrazine = 50,
			/obj/item/reagent_containers/hypospray/autoinjector/combat = 150,
			/obj/item/reagent_containers/hypospray/autoinjector/inaprovaline = 50,
			/obj/item/reagent_containers/hypospray/autoinjector/dylovene = 75,
			/obj/item/reagent_containers/hypospray/autoinjector/hypervene = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/dexalinplus = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/isotonic = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/quickclot = 100,
			/obj/item/reagent_containers/hypospray/autoinjector/synaptizine = 150,
			...
			/obj/item/reagent_containers/spray/surgery = 100,
		...
		"Engineering" = list(
			...
			/obj/item/stack/sheet/plasteel/medium_stack = 700,
			/obj/item/stack/sheet/plasteel/large_stack = 1150,
			/obj/item/stack/sheet/mineral/phoron/small_stack = 800,
			/obj/item/stack/sheet/mineral/phoron/medium_stack = 2400,
		...
		"Kitchen" = list(
			...
			/obj/item/portablecrate/soda_dispenser = 3500,
			/obj/item/portablecrate/beer_dispenser = 3500,
			/obj/item/portablecrate/condimaster = 3500,
		...
		"Equipment" = list(
			...
			/obj/item/weapon/baton/cattleprod = 1500,
			/obj/item/hailer = 500,
			...
			/obj/item/reagent_containers/spray = 20,
			/obj/item/weapon/combat_knife = 2000,
			/obj/item/weapon/gun/pistol/holdout = 1000,
			/obj/item/minerupgrade/reinforcement = 2000,
			/obj/item/minerupgrade/overclock = 2000,
			/obj/item/storage/box/monkeycubes = 4000,
			/obj/item/storage/box/monkeycubes/farwacubes = 4000,
			/obj/item/storage/box/monkeycubes/stokcubes = 4000,
			/obj/item/storage/box/monkeycubes/neaeracubes = 4000,
		...
		"Crates" = list(
			...
			/obj/item/portablecrate/chem_dispenser = 7500,
			/obj/item/portablecrate/chem_master = 5000,
			/obj/item/portablecrate/reagentgrinder = 5000,
		...
		"Prototypes" = list(
			...
			/obj/item/weapon/energy/sword = 10000,
