...
/obj/structure/largecrate/random/Initialize()
	...
	while(num_things)
		...
		var/thing = pick(prob(3);/obj/item/storage/belt/utility/full,
						...
						prob(4);/obj/item/clothing/glasses/meson,
						prob(3);/obj/item/clothing/glasses/night/m56_goggles,
						...
						prob(2);/obj/item/stack/sheet/metal/medium_stack,
						prob(1);/obj/item/stack/sheet/metal/large_stack,
						prob(1);/obj/item/stack/sheet/wood/large_stack,
						prob(2);/obj/item/stack/sheet/plasteel/medium_stack,
						prob(1);/obj/item/stack/sheet/plasteel/large_stack,
